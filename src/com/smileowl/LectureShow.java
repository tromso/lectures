...
public class LectureShow extends Activity {
	...
	private static final String urlGetPid = "http://smileowl.com/Test21/getlecture.php";
	...
	public class SearchDaMovies extends AsyncTask<String, String, String>{
			...
			protected void onPreExecute() {
	            super.onPreExecute();
	            pDialog = new ProgressDialog(LectureShow.this);
			...
			protected void onPostExecute(String result) {
	        	...
	        	if (success != 0){
	                ...
	                public void run() {
	                	 ...
	                	 mAdapter = new CustomAdapter(LectureShow.this, lectures);
	        		...
	        		Toast.makeText(LectureShow.this,"No movies found with that criteria. Try relaxing the conditions." , Toast.LENGTH_LONG).show();
	    ...
	    public View getView(final int position, View view, final ViewGroup parent) {
	        ...
	        button3.setOnClickListener(new View.OnClickListener() {
				...
				public void onClick(View view) {
					...
					Toast t = Toast.makeText(LectureShow.this, "Upvoted ", Toast.LENGTH_SHORT);
						t.show();
	        ...
	        button4.setOnClickListener(new View.OnClickListener() {
				...
				public void onClick(View view) {
					...
					Toast t2 = Toast.makeText(LectureShow.this, "Downvoted ", Toast.LENGTH_SHORT);
					t2.show();
				}
			});
	 ...
	 //opens the lecture detail page and sends the information there
	        view.setOnClickListener(new View.OnClickListener() {
	            ...
	            public void onClick(View view) {
    	            ...
    	            intent.setClass(LectureShow.this, LectureDetail.class);
